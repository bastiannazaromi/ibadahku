...
$one                             = new Template('CATATAN IBADAH HARIAN SISWA', '', base_url() . 'assets/backend');
...
$one->author                     = 'maykomputer';
$one->robots                     = 'noindex, nofollow';
$one->title                      = $title . ' | IBADAHKU';
$one->description                = 'Aplikasi Catatan Ibadah Harian Siswa';
